...
import { FolderKanban, Clock, CheckCircle2, MessageCircle, Plus, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="fade-in">
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
        ...
        {user?.role === 'Admin' && (
          <Link to="/dashboard/projects" className="btn btn-primary" style={{ gap: '0.5rem' }}>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem' }}>
        <div className="glass" style={{ padding: '2rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            ...
            <Link to="/dashboard/projects" style={{ fontSize: '0.8125rem', color: 'var(--primary)', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
        ...
        <div className="glass" style={{ padding: '2rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem', textAlign: 'center', padding: '1rem 0' }}>No recent activity logs.</p>
        </div>
      </section>
    </div>
  );
